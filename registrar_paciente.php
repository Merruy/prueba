...
<body ng-app="app" >
            ...
            <div id="text" >
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        ...
                        <table border="1">
                            <th>Nombre</th><th>Apelldio Paterno</th><th>Apellido Materno</th><th>C.I</th><th>Fecha Nacimiento</th><th>Genero</th><th>Direccion</th><th>Telefono</th><th>Email</th><th>Fecha Registro</th><th>Foto</th><th>Modificar</th>
                            <?php
                            // if ($_POST) {
	...
	<div id="footer">
		<div class="wrap">
			<div id="bubble"><p>Una linda sonrisa para ti</p></div>
			<div id="copyright">
